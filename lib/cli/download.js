              ...
              //--------------------------------------
                if(img_b64_start.test(images[index]))
                {
                  ...
                  downloadBase64Image(images[index],host,path,function(resp)
                  {
                    if(resp)
                    {
                      console.log("🠮 Downloaded image (" +Number(index+1)+") (base64)");
                ...
                else 
                {
                  ...
                  try{
                    downloadUrlImage(images[index],host,path,function()
                    {
                      console.log("🠮 Downloaded image (" +Number(index+1)+")");
                      startDownload(index+1,done);
                    });
                  }catch(err){
                      console.log("🠮 Download fail    (" +Number(index+1)+")");
